...
public class CryptoConfig implements APIConfig{
    ...
    private List<PropertyMap> cryptoMappings;
    ...
    @JsonProperty("cryptoMappings")
    public List<PropertyMap> getCryptoMappings() { return cryptoMappings; }
    @JsonProperty("cryptoMappings")
    public void setCryptoMappings(List<PropertyMap> value) { this.cryptoMappings = value; }
}
