...
public class StockConfig implements APIConfig{
    ...
    private List<PropertyMap> stockMappings;
    ...
    @JsonProperty("stockMappings")
    public List<PropertyMap> getStockMappings() { return stockMappings; }
    @JsonProperty("stockMappings")
    public void setStockMappings(List<PropertyMap> value) { this.stockMappings = value; }
}
